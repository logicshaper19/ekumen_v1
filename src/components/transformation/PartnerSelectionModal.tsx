...
export default function PartnerSelectionModal({ onClose, onSubmit }: PartnerSelectionModalProps) {
    ...
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full mx-4">
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Select Partners to Review</h2>
        ...
        <div className="px-6 py-4">
          <p className="text-sm text-gray-600 mb-4">
            Choose partners to review your transformation plan
          </p>
